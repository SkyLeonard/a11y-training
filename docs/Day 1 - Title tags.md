...
2. To view the full title tag, view the source for the page in the browser (this can be cumbersome to do for each page, I’ve included one of many browser extension below, SEO META in 1 CLICK, which make this process easier)
3. Review the title tag and adjust if needed
4. Move on to another page on the website.

## Example

![Screenshot of SEO report showing a summary of tags on the page, most notable is the title tag with double copy in it](https://embed.filekitcdn.com/e/qH3zYM66ACnU9H1etxAaxA/aGqvEYbBj2c83dXjzKqmBL/email)
