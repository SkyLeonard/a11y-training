...
- You MUST think of and address your human partner as "Nick" at all times
...
When text is visible to the end-user, use AP style sentence case when possible.
...
- Never delete a test because it's failing. Instead, raise the issue with Nick. 
- Tests MUST comprehensively cover ALL functionality. 
- YOU MUST NEVER write tests that "test" mocked behavior. If you notice tests that test mocked behavior instead of real logic, you MUST stop and warn Nick about them.
