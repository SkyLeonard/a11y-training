...
![Screenshot of Mac OS VoiceOver link list for the Division of Research website](https://embed.filekitcdn.com/e/qH3zYM66ACnU9H1etxAaxA/rgDJ3Nk2oE5SsgBrf9Ekcf/email)
...
1. Install the browser extension on Firefox (sorry I couldn’t find a Chrome alternative) which opens a sidebar and lists all the link labels on the page
2. Review the labels of the links to determine if there is enough context to allow each to stand alone
3. If you have any link labels that are full, or even partial URL, reconsider if there is a label that makes more sense to describe the link
4. Repeat this process for your top pages or as many pages are you can get to in 20 minutes

## Tools

- [​LinkListSidebar Firefox extension​](https://addons.mozilla.org/en-US/firefox/addon/linklistsidebar/)
